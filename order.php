    ...
    <div class="container">
        ...
        <form name="orderForm" action="order_action.php" method= "post" class="order" onsubmit="return validateForm()">
            ...
            <fieldset>
                ...
                <input type="text" name="customerName" placeholder="E.g. Faith Rovina" class="input-responsive" required>
                <div class="order-label">Phone Number</div>
                <input type="tel" name="phoneno" placeholder="E.g. +1234567890" class="input-responsive" required>
...
<script>
        function validateForm() {
            ...
            var phoneno = document.forms["orderForm"]["phoneno"].value;
